    ...
    <>
        ...
        <Seatmap className="seatmap">
            ...
            <Area>
                ...
                <Volume height={200} width={400} x={1150} label="Table 69" color="#ff9900" showSeatCountAsBadge={true} availableSeatCount={200} />
                <Volume height={200} width={400} x={700} y={300} label="Table 42" color="#00ff99" active={true}/>
                <Volume height={200} width={400} x={1150} y={300} label="Table 42" color="#00ff99" active={true} showSeatCountAsBadge={true} availableSeatCount={200}/>
                <Volume
                    height={200}
                    width={400}
                    x={700}
